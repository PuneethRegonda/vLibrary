      ...
      child: Column(
        children: <Widget>[
          ...
          CarouselSlider(
              ...
              items: [
                galleryCards(imageurl: "images/reading_girls.png"),
              ...
              children: <Widget>[
                ...
                child: Tooltip(
                  ...
                  decoration: BoxDecoration(
                    ...
                    child: FlatButton(
                      splashColor: Color(0xFF58d0bf).withOpacity(0.6),
                      highlightColor: Colors.transparent,
                      onPressed: (){},
                     child: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 20.0,vertical: 8.0),
                        child: Text("Faculty",style: TextStyle(color: Colors.white,fontFamily: "bebas-neue",fontSize: 20),),
                      ),
                    )) 
                ),
                  ),
